    ...
    <footer id="app-footer" className="bg-slate-900 text-slate-300 pt-16 pb-8 border-t border-slate-800 transition-colors duration-300">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          <p>© {new Date().getFullYear()} यूनिक मेडिकल एजेन्सी (Unique Medical Agency). All Rights Reserved. Developed by <a href="#" className="wmit-popup-trigger hover:text-white underline transition-colors" target="_blank" rel="noopener noreferrer">Developed by WMIT</a></p>
